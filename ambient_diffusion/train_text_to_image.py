...
def main():
    ...
    noise_scheduler = DDPMScheduler.from_pretrained("DeepFloyd/IF-I-XL-v1.0", subfolder="scheduler")
    unet = UNet2DConditionModel.from_pretrained("DeepFloyd/IF-I-XL-v1.0", subfolder="unet")
    unet.requires_grad_(True)


    if args.use_ema:
        ema_unet = UNet2DConditionModel.from_pretrained("DeepFloyd/IF-I-XL-v1.0", subfolder="unet")
    ...
    if args.dataset_name is not None:
        ...
        if args.caption_column is None:
            ...
            if caption_column not in column_names:
                print("Did not find caption column in dataset. This will lead to empty captions.")
                assert args.empty_text == True, "If no caption column is found, empty_text must be set to True."
